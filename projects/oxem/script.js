...
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mask */ "./source/js/modules/mask.js");
/* harmony import */ var _js_modules_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/modules/menu */ "./source/js/modules/menu.js");
/* harmony import */ var _js_modules_popup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/modules/popup */ "./source/js/modules/popup.js");
/* harmony import */ var _js_modules_inputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../js/modules/inputs */ "./source/js/modules/inputs.js");
/* harmony import */ var _js_modules_range__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../js/modules/range */ "./source/js/modules/range.js");
/* harmony import */ var _js_modules_calculator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../js/modules/calculator */ "./source/js/modules/calculator.js");
/* harmony import */ var _js_modules_form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../js/modules/form */ "./source/js/modules/form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_js_modules_menu__WEBPACK_IMPORTED_MODULE_2__["default"])('.menu__toggle', '.menu', '.menu__close');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_js_modules_popup__WEBPACK_IMPORTED_MODULE_3__["default"])('.popup-btn', '.popup');
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_1__["default"])('#phone');
  Object(_js_modules_inputs__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_js_modules_form__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_js_modules_range__WEBPACK_IMPORTED_MODULE_5__["default"])('#price', '.calc-inputs__line-move.price', '.calc-inputs__toggle.price', 0, 6000000);
  Object(_js_modules_range__WEBPACK_IMPORTED_MODULE_5__["default"])('#period', '.calc-inputs__line-move.period', '.calc-inputs__toggle.period', 1, 60);
  Object(_js_modules_range__WEBPACK_IMPORTED_MODULE_5__["default"])('#procent', '.calc-inputs__line-move.start-pay', '.calc-inputs__toggle.start-pay', 10, 60);
  Object(_js_modules_calculator__WEBPACK_IMPORTED_MODULE_6__["default"])();
});

/***/ }),

/***/ "./source/js/modules/calculator.js":
/*!*****************************************!*\
  !*** ./source/js/modules/calculator.js ***!
  \*****************************************/
...
var calculator = function calculator() {
  var price = document.querySelector('#price'),
      ...
      credit = 0.12 / 12,
      // процентная ставка в месяц 12% / 100 / 12
  ...
  var startPay, monthPay, sum;
  startPay = Math.floor(procent.value * price.value / 100);
  monthPay = Math.floor((price.value - startPay) * (credit + credit / (Math.pow(1 + credit, period.value) - 1)));
...
var form = function form() {
  ...
  function submit() {
    ...
    postData('https://куда-нибудь/', JSON.stringify(data)).then(function (responce) {
...
var inputs = function inputs() {
  ...
  var setValidity = function setValidity(input) {
    function showMessage(msg) {
      input.parentNode.classList.remove('form__field--valid');
      input.parentNode.classList.add('form__field--invalid');
      var message = document.querySelector("#".concat(input.getAttribute('id'), " + span"));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var menu = function menu(toggleSelector, menuSelector, closeBtn) {
...
var popup = function popup(triggerSelector, popupSelector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_calculator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/calculator */ "./source/js/modules/calculator.js");


var range = function range(inputSelector, lineSelector, toggleSelector, min, max) {
  var input = document.querySelector(inputSelector),
      line = document.querySelector(lineSelector),
      toggleBtn = document.querySelector(toggleSelector);

  var dropToggle = function dropToggle(toggle, evt) {
    evt.preventDefault();
    var startX = evt.type === 'touchstart' ? evt.targetTouches[0].clientX : evt.clientX;

    var onMouseMove = function onMouseMove(moveEvt) {
      moveEvt.preventDefault();
      var shift = evt.type === 'touchstart' ? startX - moveEvt.targetTouches[0].clientX : startX - moveEvt.clientX;
...
var slider = function slider() {
  var setSlider = function setSlider(slides, slider, prev, next, dotsSelector) {
    ...
    function showSlide(n) {
      ...
      dots.forEach(function (dot) {
        return dot.classList.remove('slider__dot--active');
      });
