...
/* harmony import */ var _modules_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/menu */ "./source/js/modules/menu.js");
/* harmony import */ var _modules_price__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/price */ "./source/js/modules/price.js");
...
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/timer */ "./source/js/modules/timer.js");
...
/* harmony import */ var _modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/checkTextInputs */ "./source/js/modules/checkTextInputs.js");
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/mask */ "./source/js/modules/mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var deadline = document.querySelector('#timer').getAttribute('data-deadline');
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_modules_price__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('#timer', deadline);
...
/***/ "./source/js/modules/checkTextInputs.js":
/*!**********************************************!*\
  !*** ./source/js/modules/checkTextInputs.js ***!
  \**********************************************/
...
var forms = function forms() {
  ...
  form.addEventListener('submit', function (e) {
    ...
    postData(path, data).then(function (responce) {
...
var price = function price() {
  var buttons = document.querySelectorAll('.price__item span'),
      submenus = document.querySelectorAll('.price__submenu');

  function clean() {
    buttons.forEach(function (item) {
      return item.classList.remove('price__btn--active');
    });
    submenus.forEach(function (item) {
      return item.classList.remove('price__submenu--active');
    });
  }
...
var timer = function timer(id, deadline) {
  ...
  var setTimer = function setTimer(selector, endtime) {
