...
/* harmony import */ var _modules_renderGameField__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/renderGameField */ "./src/js/modules/renderGameField.js");
/* harmony import */ var _modules_replay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/replay */ "./src/js/modules/replay.js");
/* harmony import */ var _modules_gameMechanic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/gameMechanic */ "./src/js/modules/gameMechanic.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_gameMechanic__WEBPACK_IMPORTED_MODULE_2__["default"])(gameStatus);
});
...
var AI = function AI(state) {
  var checkCellsForTurn = function checkCellsForTurn(prevCell) {
    var col = prevCell.getAttribute("data-col"),
    ...
    function getDiagonal(direction) {
      ...
      var _loop = function _loop(i) {
        ...
        cells.forEach(function (item) {
          if (item.getAttribute("data-col") === "".concat(col) && item.getAttribute("data-row") === "".concat(row)) {
            diagonal.push(item);
          }
        });
      };
...
/***/ "./src/js/modules/gameMechanic.js":
/*!****************************************!*\
  !*** ./src/js/modules/gameMechanic.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _AI__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./AI */ "./src/js/modules/AI.js");
...
var gameMechanic = function gameMechanic(state) {
  var cells = document.querySelectorAll('.cell'),
      currentPlayer = document.querySelector('.current-player');

  var checkCellsForWin = function checkCellsForWin(cellPressed, player) {
    var col = cellPressed.getAttribute("data-col"),
    ...
    function checkLine(elems) {
      ...
      if (line.includes(state.winCombo)) {
        ...
        elems.forEach(function (item, i) {
          if (i >= line.indexOf(state.winCombo) && i <= line.indexOf(state.winCombo) + 4) {
  ...
  var gameOver = function gameOver() {
    var popup = document.querySelector('.game-over'),
...
/* harmony default export */ __webpack_exports__["default"] = (gameMechanic);

/***/ }),

/***/ "./src/js/modules/renderGameField.js":
/*!*******************************************!*\
  !*** ./src/js/modules/renderGameField.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (renderGameField);

/***/ }),

/***/ "./src/js/modules/replay.js":
/*!**********************************!*\
  !*** ./src/js/modules/replay.js ***!
  \**********************************/
/*! exports provided: default */
...
var replay = function replay(state) {
